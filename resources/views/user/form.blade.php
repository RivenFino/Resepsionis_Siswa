...
<div class="h-auto w-full mt-32 flex flex-col items-center">
    <form action="/process-form" enctype="multipart/form-data" method="POST" class="w-1/2 max-sm:px-3 px-8 h-full transition-all">
        @csrf
        <div class="flex flex-col">
            ...
            <div class="flex w-full gap-6 py-4 text-sm px-8 max-sm:flex-col">
                ...
                <div class="flex flex-col w-full text-lg max-sm:flex-colz`">
                    ...
                    <textarea type="text" name="keterangan" id="keterangan" class="h-10 max-h-20 border mt-1 rounded px-4 w-full bg-gray-50 focus:border-none focus:outline-none outline-none" value="" max="255"></textarea>
                </div>
            </div>
